    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className={`rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden ${
          ...
          <div className={`border-b p-4 ${
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                }`}>How to Use Utility Adjustments</h4>
                ...
                <div className="mt-3 flex flex-wrap gap-2 text-xs">
                  ...
                  }`}>1-2: Essentially Worthless</span>
                  <span className={`px-2 py-1 rounded ${
                    isDark 
            ...
            {loading ? (
              <div className="flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  <p className={isDark ? 'text-gray-300' : 'text-gray-600'}>Loading item types...</p>
                </div>
              </div>
            ) : (
              ...
              {Object.values(ITEM_CATEGORIES).map((category) => {
                ...
                return (
                  <div key={category} className={`rounded-xl p-6 ${
